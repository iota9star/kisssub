 ...
 */
public class AestheticPureTabLayout extends TabLayout {
    ...
    public AestheticPureTabLayout(Context context) {
        super(context);
    }

    public AestheticPureTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AestheticPureTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
